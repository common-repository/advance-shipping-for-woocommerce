...
$afads_condition_type     = get_post_meta( $current_post_id, 'afads_condition_type', true );
$afads_condition_operator = get_post_meta( $current_post_id, 'afads_condition_operator', true );
$afads_condition_value    = get_post_meta( $current_post_id, 'afads_condition_value', true );

$group_id     = 0;
$condition_id = 0;

?>
<div class="afads-shipping-instance-fields">
